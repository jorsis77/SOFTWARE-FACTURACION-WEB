...
CREATE TABLE T002_TIPOS_IDTF (
  ...
  F002_ACTIVO CHAR(1) CHACK (F002_ACTIVO IN ('S','N'));
...
-- CMAPOS OPCIONALES MOSTRAR DE ULRIJMO PARA DIDGITACION 
 ...
 F000_CORREO_SOPORTE VARCHAR  (25) NULL, -- CORREO PARA MOSTRAR
  ...
  F000_CODIGO NUMERIC (3,0),  -- FK COD EMPRESA DEL USUARIO
  ADD CONSTRAINT FK_F000_CODIGO_T013   FOREIGN KEY  (F000_CODIGO)  REFERENCES T000_EMPRESAS(F000_CODIGO);  --  GENERICO 
