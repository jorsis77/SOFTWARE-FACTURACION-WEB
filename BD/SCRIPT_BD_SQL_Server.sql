...
-- CMAPOS OPCIONALES MOSTRAR DE ULRIJMO PARA DIDGITACION 
 ...
 F000_CORREO_SOPORTE VARCHAR  (25) NULL, -- CORREO PARA MOSTRAR
  ...
  CONSTRAINT FK_F058_CODIGO_T058  FOREIGN KEY  (F058_CODIGO) REFERENCES T058_PAIS(F058_CODIGO), -- CODIGO DEL PAIS PRINCIPAL DE LA EMPRESA
);
...
CREATE TABLE T013_USUARIO (
 ...
 -- F050_CODIGO NUMERIC(3,0)  NOT NULL  ,  --  COD ROL
  ...
  F013_PASWORD VARCHAR(30) NOT  NULL  ,      --PASWORD
  F013_SALT VARCHAR(50) NOT NULL,
  F013_CORREO VARCHAR(60)  NOT NULL  , ----- UNICOOOOO es el login
