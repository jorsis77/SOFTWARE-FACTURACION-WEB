...
--SELECT   *FROM T002_TIPOS_IDTF
CREATE TABLE T002_TIPOS_IDTF (
  F002_CODIGO VARCHAR(3)  NOT NULL  ,
  F002_DESCRIPCION VARCHAR(20)  NOT NULL    ,
  F002_ACTIVO CHAR(1) CHECK (F002_ACTIVO IN ('S','N')),
PRIMARY KEY(F002_CODIGO));
CREATE UNIQUE INDEX T002_F002_DESCRIPCION_IDX ON T002_TIPOS_IDTF(F002_DESCRIPCION); 




INSERT INTO T002_TIPOS_IDTF VALUES('C.C','CEDULA CIUDADANO','S');
INSERT INTO T002_TIPOS_IDTF VALUES('NIT','NIT EMPRESA','S');
INSERT INTO T002_TIPOS_IDTF VALUES('T.I','TARJETA IDENTIDAD','S');
INSERT INTO T002_TIPOS_IDTF VALUES('PSP','PASAPORTE','S');



CREATE TABLE T050_ROLE (
  F050_CODIGO NUMERIC(3,0) PRIMARY KEY IDENTITY(1,1) NOT NULL   , --  COD ROL
...
CREATE UNIQUE INDEX T050_F050_NOMBRE_ROL_IDX ON T050_ROLE(F050_NOMBRE_ROL); 
